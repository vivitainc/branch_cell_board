...
#  define VPARTS_EN_PWR_DDR  (DDRE)
#  define VPARTS_EN_PWR_PORT (PORTE)
#  define VPARTS_EN_PWR_PIN  (PINE0)
...
#  define VPARTS_EN_PWR_DDR  (DDRC)
#  define VPARTS_EN_PWR_PORT (PORTC)
#  define VPARTS_EN_PWR_PIN  (PINC3)
#endif
